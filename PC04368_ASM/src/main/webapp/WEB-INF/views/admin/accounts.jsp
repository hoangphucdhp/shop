			...
			<div class="py-4 text-gray-500 dark:text-gray-400">
				...
				<ul>
					<li class="relative px-6 py-3"><span
						...
						aria-hidden="true"></span> <a
						class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100"
						href="/admin/account"> <svg class="w-5 h-5" aria-hidden="true"
								fill="none" stroke-linecap="round" stroke-linejoin="round"
								stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                  <path
									d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path>
                  ...
                  <path
					...
					<li class="relative px-6 py-3"><a
						class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
						href="/admin/chart"> <svg class="w-5 h-5" aria-hidden="true"
								fill="none" stroke-linecap="round" stroke-linejoin="round"
								stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                  <path
									d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z"></path>
		...
		<div class="flex flex-col flex-1">
			...
			<main class="h-full pb-16 overflow-y-auto">
				<div class="container px-6 mx-auto grid">
					...
					<form:form action="/account/index" modelAttribute="account"
						method="post" enctype="multipart/form-data">
						<div
							class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
							<form:label path="username" class="block text-sm">
							...
							<form:label path="password" class=" mt-4 block text-sm">
								<span class="text-gray-700 dark:text-gray-400">Password</span>
								<form:input path="password"
									class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
									type="password" placeholder="Jane Doe" />
							</form:label>


							<form:label path="fullname" class=" mt-4 block text-sm">
							...
							<form:label path="email" class=" mt-4 block text-sm">
							...
							<div class="mt-4 text-sm">
								<label for="photo">Photo</label> <input type="file" name="file" /><br />
							</div>
							...
							<!-- <div class="mt-4 text-sm">
								...
								<div class="mt-2">
									<label
										...
										name="accountType" value="personal" /> <span
										class="ml-2">Admin</span>
									</label> <label
										class="inline-flex items-center ml-6 text-gray-600 dark:text-gray-400">
										<input type="radio"
										class="text-purple-600 form-radio focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
										name="accountType" value="busines" /> <span
										class="ml-2">User</span>
									</label>
								</div>
							</div> -->

							<!-- HTML !-->
							<button formaction="/account/create" formmethod="post"
								class="buttonAdd">Create</button>
							<button formaction="/account/update" formmethod="post"
								class="buttonUpdate">Update</button>
							<a class="btn btn-info mr-3 mt-2 mb-2" href="/admin/accounts"><i
								...
								<c:forEach var="item" items="${page.content}" varStatus="loop">
									<tbody
										...
										<tr class="text-gray-700 dark:text-gray-400">
											...
											<td class="px-4 py-3 text-sm">${item.password }</td>
											<td class="px-4 py-3 text-xs">${item.fullname }</td>
											<td class="px-4 py-3 text-sm">${item.email }</td>
											<td class="px-4 py-3 text-sm"><img alt=""
												src="/images/${item.photo}"></td>
											<td class="px-4 py-3 text-sm">${item.activated }</td>
											<td class="px-4 py-3 text-sm">${item.admin }</td>
											<td class="px-4 py-3 text-sm"><a
												class="btn btn-primary mr-2"
												href="/account/edit/${item.username }" role="button">Edit</a></td>
											<td class="px-4 py-3 text-sm"><a
												class="btn btn-danger mr-2"
												href="/account/delete/${item.username }" role="button">Delete<i
									...
									<ul class="inline-flex items-center">
										<li>
											<button
												...
												aria-label="Previous">
												<a class="btn btn-primary" href="/admin/accounts?p=0"
													role="button">First</a>
											</button>
										</li>
										<li>
											<button
												...
												<a class="btn btn-primary"
													href="/admin/accounts?p=${page.number-1}" role="button">Previous</a>
											</button>
										</li>
										<li>
											<button
												class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple">
												<a class="btn btn-primary"
													href="/admin/accounts?p=${page.number+1}" role="button">Next</a>
											</button>
										</li>
										<li>
											<button
												class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple">
												<a class="btn btn-primary"
													href="/admin/accounts?p=${page.totalPages-1}" role="button">Last</a>
											</button>
										</li>
