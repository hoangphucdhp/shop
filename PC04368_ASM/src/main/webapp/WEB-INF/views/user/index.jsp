							...
							<div class="nav-item dropdown">
								...
								<div class="dropdown-menu bg-primary rounded-0 border-0 m-0">
									...
									<a href="/user/login" class="dropdown-item">Sign in</a> <a
										href="/user/registration" class="dropdown-item">Sign up</a>

									<% } else { %>

									<a href="/logout" class="dropdown-item">Logout</a> <a
										href="/user/changePassword" class="dropdown-item">Change
										Password</a>
		...
		<div class="row px-xl-5">
					...
					<div class="carousel-inner">
						<div class="carousel-item position-relative active"
							...
							<img class="position-absolute w-100 h-100"
								src="/forUser/img/carousel-1.jpg" style="object-fit: cover;">
							<div
						...
						<div class="carousel-item position-relative"
							style="height: 430px;">
							<img class="position-absolute w-100 h-100"
								src="/forUser/img/carousel-2.jpg" style="object-fit: cover;">
							<div
								class="carousel-caption d-flex flex-column align-items-center justify-content-center">
								<div class="p-3" style="max-width: 700px;">
									<h1
						...
						<div class="carousel-item position-relative"
							style="height: 430px;">
							<img class="position-absolute w-100 h-100"
								src="/forUser/img/carousel-3.jpg" style="object-fit: cover;">
							<div
								class="carousel-caption d-flex flex-column align-items-center justify-content-center">
								<div class="p-3" style="max-width: 700px;">
									<h1
			...
			<div class="col-lg-4">
				<div class="product-offer mb-30" style="height: 200px;">
					<img class="img-fluid" src="/forUser/img/offer-1.jpg" alt="">
				...
				<div class="product-offer mb-30" style="height: 200px;">
					<img class="img-fluid" src="/forUser/img/offer-2.jpg" alt="">
					<div class="offer-text">
						<h6 class="text-white text-uppercase">Save 20%</h6>
						<h3 class="text-white mb-3">Special Offer</h3>
						<a href="" class="btn btn-primary">Shop Now</a>
					...
					<a class="text-decoration-none" href="/category/${category.id}">
						<div class="cat-item img-zoom d-flex align-items-center mb-4">
							<div class="overflow-hidden" style="width: 100px; height: 100px;">
								<img class="img-fluid"
									src="https://image.uniqlo.com/UQ/ST3/vn/imagesgoods/455471/item/vngoods_06_455471.jpg?width=750"
									alt="">
							</div>
							...
							<div class="product-img position-relative overflow-hidden">
								...
								<div class="product-action">
									<a class="btn btn-outline-dark btn-square"
										href="/cart/add/${item.id}"><i class="fa fa-shopping-cart"></i></a>
