...
<body>
		...
		<div class="row bg-secondary py-1 px-xl-5">
			...
			<div class="col-lg-6 text-center text-lg-right">
				...
				<div class="d-inline-flex align-items-center d-block d-lg-none">
					...
					</a> <a href="/user/cart" class="btn px-0 ml-2"> <i
	...
	<div class="container-fluid bg-dark mb-30">
		<div class="row px-xl-5">
			...
			<div class="col-lg-9">
				<nav
					class="navbar navbar-expand-lg bg-dark navbar-dark  py-lg-0 px-0">
				...
				<div id="product-carousel" class="carousel slide"
					...
					<div class="carousel-inner bg-light">
						<div class="carousel-item active">
							<img class="w-100 h-100" src="/images/${product.image }"
								alt="Image">
						</div>
						<!-- <div class="carousel-item">
                            <img class="w-100 h-100" src="/forUser/img/product-2.jpg" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="/forUser/img/product-3.jpg" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="/forUser/img/product-4.jpg" alt="Image">
                        </div> -->
					</div>
			...
			<div class="col-lg-7 h-auto mb-30">
				<div class="h-100 bg-light p-30">
					...
					<div class="d-flex align-items-center mb-4 pt-2">
						...
						<a class="btn btn-primary" href="/cart/add/${product.id}"
							role="button"><i class="fa fa-shopping-cart mr-1"></i> Add to
							cart</a>
							...
							<div class="row">
								<div class="col-md-6">
									...
									<div class="media mb-4">
										<img src="/forUser/img/user.jpg" alt="Image"
		...
		<div class="col p-30">
			<section class="bg-light">
				<div class="container px-4 px-lg-5 mt-5">
					...
					<div
						class="row mb-4 gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
						<div class="col mb-5">
								...
								<div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
									<div class="text-center">
										<a class="btn btn-outline-dark mt-auto"
											href="/cart/add/${product.id}">Add to cart</a>
									</div>
								</div>
							</div>
						</div>
	...
	<div class="container-fluid bg-dark text-secondary mt-5 pt-5">
		...
		<div class="row border-top mx-xl-5 py-4"
			...
			<div class="col-md-6 px-xl-0 text-center text-md-right">
				<img class="img-fluid" src="/forUser/img/payments.png" alt="">
			</div>
		</div>
	</div>
	<!-- Footer End -->
