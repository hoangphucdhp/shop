							...
							<form method="GET" action="/user/shop">
								<div class="input-group">
									<input type="text" name="name" class="form-control"
										placeholder="Search for products" value="${savedKeyword}" />
		...
		<div class="row px-xl-5">
							...
							<div class="ml-2">
								<div class="btn-group">
									...
									<div class="dropdown-menu dropdown-menu-right">
										<a class="dropdown-item" href="/user/shop?field=name">Name</a>
										<a class="dropdown-item" href="/user/shop?field=price">Price</a>
										<a class="dropdown-item" href="/user/shop?field=createDate">Date</a>
									</div>
								</div>
            ...
            <tr>
                ...
                <td>${product.name}</td>
					...
					<c:forEach items="${page.content}" var="product" varStatus="loop">
						<div class="col-lg-4 col-md-6 col-sm-6 pb-1">
							<div class="product-item bg-light mb-4">
								<div class="product-img position-relative overflow-hidden">
									<img class="img-fluid w-100" src="/images/${product.image}"
										alt="">
						...
						<nav>
							<ul class="pagination justify-content-center">
								<li class="page-item "><a class="page-link"
									href="/user/shop?p=0&name=${savedKeyword}">First</span></a></li>
								<li class="page-item "><a class="page-link"
									href="/user/shop?p=${page.number-1}&name=${savedKeyword}">Previous</a></li>
								<li class="page-item"><a class="page-link"
									href="/user/shop?p=${page.number+1}&name=${savedKeyword}">Next</a></li>
								<li class="page-item"><a class="page-link"
									href="/user/shop?p=${page.totalPages-1}&name=${savedKeyword}">Last</a></li>
